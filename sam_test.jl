...
function CPU_calc()
    ...
    # => @floop ThreadedEx(basesize = qG.nT ÷ qG.num_threads) for tii in prm.ts.time_keys
        ...
        # tools
        stt.cos_ftp[tii] .= QuasiGrad.LoopVectorization.cos_fast.(stt.va_fr[tii] .- stt.va_to[tii])
        stt.sin_ftp[tii] .= QuasiGrad.LoopVectorization.sin_fast.(stt.va_fr[tii] .- stt.va_to[tii])
        stt.vff[tii]     .= QuasiGrad.LoopVectorization.pow_fast.(stt.vm_fr[tii],2)
        stt.vtt[tii]     .= QuasiGrad.LoopVectorization.pow_fast.(stt.vm_to[tii],2)
        stt.vft[tii]     .= stt.vm_fr[tii].*stt.vm_to[tii]
        ...
        stt.acline_sfr[tii] .= QuasiGrad.LoopVectorization.sqrt_fast.(QuasiGrad.LoopVectorization.pow_fast.(stt.acline_pfr[tii],2) .+ QuasiGrad.LoopVectorization.pow_fast.(stt.acline_qfr[tii],2))
        ...
        # apparent power flow -- to -> from
        stt.acline_sto[tii] .= QuasiGrad.LoopVectorization.sqrt_fast.(QuasiGrad.LoopVectorization.pow_fast.(stt.acline_pto[tii],2) .+ QuasiGrad.LoopVectorization.pow_fast.(stt.acline_qto[tii],2))
    end
