...
function mat_vec_kernel!(y::CuDeviceMatrix{Float64}, A::CuDeviceMatrix{Float64}, x::CuDeviceMatrix{Float64}, offset::Int)
...
function mat_vec_prod!(y::CuDeviceMatrix{Float64}, A::CuDeviceMatrix{Float64}, x::CuDeviceMatrix{Float64}, max_threads_per_block::Int, max_grid_dim_y::Int)
